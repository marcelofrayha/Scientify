...
export interface ScientifyInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "authorAttestations",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export interface Scientify extends BaseContract {
  ...
  attestAuthorship: TypedContractMethod<
    [documentHash: string, linkedAttestationId: BigNumberish],
    [void],
    "nonpayable"
  >;

  authorAttestations: TypedContractMethod<
    [arg0: AddressLike],
    [bigint],
    "view"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "authorAttestations"
