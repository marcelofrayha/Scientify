...
import type {
  ISP,
  ISPInterface,
} from "../../../../../@ethsign/sign-protocol-evm/src/interfaces/ISP";
...
export class ISP__factory {
  static readonly abi = _abi;
  static createInterface(): ISPInterface {
    return new Interface(_abi) as ISPInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): ISP {
    return new Contract(address, _abi, runner) as unknown as ISP;
  }
}
